...
Public Member Functions | Public Attributes | List of all members  RApi::OrderCancelReport Class Reference

`#include <RApiPlus.h>`  Inheritance diagram for RApi::OrderCancelReport:
...
The OrderCancelReport represents a cancellation of an order and is passed in RCallbacks::CancelReport().

The OrderCancelReport class conveys information about a cancellation of a full or partial order, depending on what portion of the order could be cancelled.
**See also**
...
## dump()
     **
| int OrderCancelReport::dump | ( | int * | aiCode | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| OrderCancelReport::llCancelledSize |
| --- |
