...
Public Member Functions | Public Attributes | List of all members  RApi::OrderStatusReport Class Reference

`#include <RApiPlus.h>`  Inheritance diagram for RApi::OrderStatusReport:
...
The OrderStatusReport represents the successful placement of an order and is passed in RCallbacks::StatusReport().

The OrderStatusReport class conveys information about the new order.
**See also**
...
## dump()
     **
| int OrderStatusReport::dump | ( | int * | aiCode | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| OrderStatusReport::llConfirmedSize |
| --- |

Quantity that was successfully placed.
