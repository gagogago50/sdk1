...
# RApi::StopLimitOrderParams

Public Member Functions | Public Attributes | List of all members  RApi::StopLimitOrderParams Class Reference

`#include <RApiPlus.h>`  Inheritance diagram for RApi::StopLimitOrderParams:
...
|  |
| Public Member Functions inherited from RApi::LimitOrderParams |
| int | clearHandles (int *aiCode) |
|  |
|  | LimitOrderParams () |
|  |
...
|  |
| Public Attributes inherited from RApi::LimitOrderParams |
| double | dPrice |
|  |
| long long | llQty |
|  |
...
| StopLimitOrderParams::StopLimitOrderParams | ( |  | ) |  |
| --- | --- | --- | --- | --- |
...
## clearHandles()
    **
| int StopLimitOrderParams::clearHandles | ( | int * | aiCode | ) |  |
| --- | --- | --- | --- | --- | --- |
...
| RApi::StopLimitOrderParams::dTriggerPrice |
| --- |

This member variable indicates the trigger price at which to place the limit order.
