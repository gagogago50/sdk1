> **Source:** https://www.sierrachart.com/index.php?page=doc/DTCMessageDocumentation.php

# DTC Messages and Procedures -  Sierra Chart

#### [Home](https://www.sierrachart.com/) >> [Getting Started](https://www.sierrachart.com/index.php?page=doc/DTCMessageDocumentation.php)
...
- [All DTC Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_All.php)
- [Authentication and Connection Monitoring Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php)
- [Market Data Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php)
- [Order Entry and Modification Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php)
- [Trading Related Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php)
- [Account List Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AccountListMessages.php)
- [Symbol Discovery and Security Definitions Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_SymbolDiscoverySecurityDefinitionsMessages.php)
- [Account Balance Data Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AccountBalanceDataMessages.php)
- [Logging Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_LoggingMessages.php)
- [Historical Price Data Messages (Opens a New Page)](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php)
...
For an overview of the DTC Protocol, refer to the [Data and Trading Communications Protocol](https://www.sierrachart.com/index.php?page=doc/DTCProtocol.php) page.

For the DTC Protocol header files, refer to the [DTC Files](https://www.sierrachart.com/index.php?page=doc/DTCProtocol.php#DTCFiles) section. The files to use depend upon the particular [encoding](https://www.sierrachart.com/index.php?page=doc/DTCProtocol.php#MessageFormatEncoding) to use. In the case of JSON encoding, there are no header files to use.
...
If a Server does not support a particular message or class of messages, it will indicate this through various 1 byte integer fields in the [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message. A byte value of 1 signifies the field is TRUE.  A byte value of 0 signifies the field is FALSE.
...
When there are new messages added to the DTC Protocol or new fields added to a structure,  then the protocol version number in the  [LOGON_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_REQUEST) and [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) messages will be incremented.
...
The header file for [DTC Binary Encoding with Fixed Length Strings](https://www.sierrachart.com/DTC_Files/DTCProtocol.h)  has the data structures located in the **DTC** namespace.

The header file for  [DTC Binary Encoding with Variable Length Strings](https://www.sierrachart.com/DTC_Files/DTCProtocolVLS.h), has the data structures located within the  **DTC_VLS** namespace.
...
1. A DTC Client establishes a TCP/IP connection to the Server. This can be either TLS or non-TLS. It is highly recommended the Server enables [TCP No Delay](https://en.wikipedia.org/wiki/Nagle%27s_algorithm) when the Server accepts the connection.
2. It is important to understand that the DTC protocol uses different encodings for messages. For more information refer to [Message Format and Encoding](https://www.sierrachart.com/index.php?page=doc/DTCProtocol.php#MessageFormatEncoding).  Messages must be exchanged between the Client and Server using the desired encoding.
...
3. The Client fills out a [LOGON_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_REQUEST)  message structure and sends it to the Server over the network socket. Only the message fields which are relevant for the particular Server being connected to, need to be set. 

The [LOGON_REQUEST::HeartbeatIntervalInSeconds](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_REQUEST) must be set by the Client.
4. The Client will wait for a [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message structure from the Server. 


                The Server will always respond with an  [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message.  It must set the **s_LogonResponse::Result** field. The following are the supported constants for the Result field: **LOGON_SUCCESS**, **LOGON_ERROR**, **LOGON_ERROR_NO_RECONNECT**, **LOGON_RECONNECT_NEW_ADDRESS**.
...
5. If the **Result** field is set to **LOGON_SUCCESS**, then this indicates to the Client a successful logon. At this time, the Client can interpret the other fields in the [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message and send other messages to the Server.
...
7. In the [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message if the **s_LogonResponse::Result** member is set to **LOGON_RECONNECT_NEW_ADDRESS**, then this signals to the Client reconnect to the address given in  **s_LogonResponse::ReconnectAddress**.
8. The [LOGON_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_REQUEST) indicates a Heartbeat interval that each side needs to follow.  Each side will send a [HEARTBEAT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-HEARTBEAT) message structure at the given interval in seconds.
9. At this point, the Client can make requests to the Server by sending any of the other supported [DTC Messages](https://www.sierrachart.com/index.php?page=doc/DTCMessages_All.php). If a particular class of messages is not supported by the Server, the Client will become aware of this by  examining the related variables in the [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message.

### Encoding Request Sequence

[Link] - [Top]

The [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) and [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) messages were added in version 6 of the DTC Protocol. These control the particular message encoding to be used during the connection.
...
2. In version 6 or higher of the DTC Protocol, all Servers *must respond* to the [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) message, even if it is only to reject a requested change and set the encoding to the current Server supported encoding value.
3. During the initial exchange of the [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) and [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) messages at the beginning of the network connection, these must be both sent using  Binary Encoding.


             However, there is an exception to this.  If the Server has been  *preset* to a particular encoding at the start of a connection and this has been disclosed to the Client by some other non-technical means, then the Client must  send the [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST)  to the Server using the encoding the Server is currently set to and not necessarily Binary Encoding.
4. For a Client using JSON Encoding to be able to connect to a Server, the Client needs to form and process the initial Encoding Request and Encoding Response messages using the standard Binary Encoding [s_EncodingRequest message structure](https://www.sierrachart.com/DTC_Files/DTCProtocol.h).
5. The Client sends an [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) message to the Server with the requested encoding.  This message must be sent using  Binary Encoding if it is the first message sent in the data stream during the connection. The Server must be able to respond  to this message using Binary Encoding as well.
6. The Client waits for the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) from the Server. If the Client has not received a response within a reasonable time,  like 20 seconds, the Client should close the network connection because it cannot reliably communicate with the Server until it  knows the message encoding.
7. The Server receives the [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) message, and responds with an [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) message. 



            If the Server accepts the requested enocding, the **Encoding** field in the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) must be set to the value from the [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) message. 


            If the Server rejects the requested encoding, the **Encoding** field in the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) message must be set to the current encoding value used by the Server. 


            Servers that only support one encoding must still respond to an [ENCODING_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_REQUEST) by sending an [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) message with the **Encoding** field set to the particular DTC encoding that the Server supports.


            In either case, the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) is sent using the  *encoding* the Server is currently using,   *before the requested change*, which usually will be Binary Encoding if it is the first message at the beginning of the network connection. All subsequent messages are sent using the new encoding if it was accepted by the Server.
8. The Client receives the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) message and processes it using the original encoding which is Binary Encoding. The Client then changes encoding specified by the **Encoding** field in the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) message. All subsequent messages must be sent and received using the potential new encoding.
9. While the encoding request sequence is typically performed before sending the [LOGON_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_REQUEST) message, the sequence can technically be performed at anytime. The only restriction is that the Client should stop sending new messages and continue processing received messages with the current encoding until the encoding is changed with an [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE). This also includes processing the [ENCODING_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-ENCODING_RESPONSE) message with the current encoding.  After that message the Client will use the new potential encoding.

### Logging Off

[Link] - [Top]

A logoff can be performed by either side by sending a [LOGOFF](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGOFF) message to the other side and gracefully closing the socket with a linger.

The Server and the Client will always write complete messages into the socket. When either side wants to logoff and disconnect it will send a [LOGOFF](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGOFF) message to the other side and gracefully close the socket.

The only exception to this  is when the Server sends a [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE)message to the Client  with the **Result** field set to a value other than  **LOGON_SUCCESS**, then it can gracefully close the network connection after without sending a [LOGOFF](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGOFF) message to the Client.

### Market Data

[Link] - [Top]

A Client will subscribe and unsubscribe to market data for a symbol by using the [MARKET_DATA_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_REQUEST) message. When subscribing to  market data for a symbol, the request is identified by  a unique  SymbolID field.
...
After a Client subscribes to market data, the Server will respond with any of the **Server >> Client** [Market Data Messages](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php) currently defined in the DTC Protocol.
...
1. A Client will  subscribe to market data by using the [MARKET_DATA_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_REQUEST) message.
2. If the Client has subscribed to an invalid symbol or there is some problem the Server finds with the [MARKET_DATA_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_REQUEST) message the Server will respond with a [MARKET_DATA_REJECT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_REJECT) message. At this point, there is nothing further the Server needs to respond with.
3. If the Client has subscribed to a valid symbol, the Server will respond immediately with a [MARKET_DATA_SNAPSHOT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_SNAPSHOT) message, providing as many of the message fields as possible.
4. When there is a change with the Bid or Ask prices or quantities for the symbol subscribed to, the Server will send a [MARKET_DATA_UPDATE_BID_ASK](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_BID_ASK) message to the Client. If the Symbol only provides Bid and Ask updates, then  this message will  be used.  **MARKET_DATA_UPDATE_TRADE** messages will not be sent in this case.
5. When a new trade occurs for the symbol subscribed to,  the Server will send a [MARKET_DATA_UPDATE_TRADE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_TRADE) message to the Client.
6. When the session trade volume for the symbol changes, the Server can send a [MARKET_DATA_UPDATE_SESSION_VOLUME](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_SESSION_VOLUME) message. However, for the complete details of when the session trade volume message should be sent the Client, refer to the documentation for [MARKET_DATA_UPDATE_SESSION_VOLUME](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_SESSION_VOLUME).
7. When a new session High or Low occurs for the symbol,  the Server will send a [MARKET_DATA_UPDATE_SESSION_HIGH](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_SESSION_HIGH) or [MARKET_DATA_UPDATE_SESSION_LOW](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_SESSION_LOW) message.
8. When there is a change of the session Settlement price, session Open price or the Open Interest value for the symbol, the Server will send a [MARKET_DATA_UPDATE_SESSION_SETTLEMENT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_SESSION_SETTLEMENT), [MARKET_DATA_UPDATE_SESSION_OPEN](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_SESSION_OPEN), or [MARKET_DATA_UPDATE_OPEN_INTEREST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_OPEN_INTEREST) message respectively.
9. If any of the other fields in a [MARKET_DATA_SNAPSHOT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_SNAPSHOT) message change and there is no corresponding **MARKET_DATA_UPDATE_*** message available for that field, then the Server will send a new [MARKET_DATA_SNAPSHOT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_SNAPSHOT) message. This message is intended to be sent infrequently.
10. If the Client requires market depth data beyond the best Bid and  Ask level, then it will request it with a [MARKET_DEPTH_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DEPTH_REQUEST) message. The Client shall only request market depth data if  **s_LogonResponse::MarketDepthIsSupported** is set to 1.


            If the market depth request is rejected for any reason, the Server will send a [MARKET_DEPTH_REJECT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DEPTH_REJECT) message to the Client.
11. If the market depth request is accepted by the Server, then it will respond immediately with a series of [MARKET_DEPTH_SNAPSHOT_LEVEL](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DEPTH_SNAPSHOT_LEVEL) messages which the Client uses to build its initial market depth book.
12. In order to conserve bandwidth, the Server can optionally set **s_LogonResponse::MarketDepthUpdatesBestBidAndAsk** to 1  and when beginning to send market depth data in response to a [MARKET_DEPTH_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DEPTH_REQUEST), it should then stop best Bid and Ask updates through a [MARKET_DATA_UPDATE_BID_ASK](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DATA_UPDATE_BID_ASK) message. 
...
13. As the market depth data changes, the Server will send to the Client [MARKET_DEPTH_UPDATE_LEVEL](https://www.sierrachart.com/index.php?page=doc/DTCMessages_MarketDataMessages.php#Messages-MARKET_DEPTH_UPDATE_LEVEL) messages to update the market depth book. Each message updates one level of depth on one side.
14. If a Client makes a request for Security Definition data with the [SECURITY_DEFINITION_FOR_SYMBOL_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_SymbolDiscoverySecurityDefinitionsMessages.php#Messages-SECURITY_DEFINITION_FOR_SYMBOL_REQUEST) message, the Server will respond to this request with a  [SECURITY_DEFINITION_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_SymbolDiscoverySecurityDefinitionsMessages.php#Messages-SECURITY_DEFINITION_RESPONSE) and provide as many of the message fields as possible.
...
When the Client connects to the Server, it will make a request for the list of  [Trading Accounts](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AccountListMessages.php#Messages-TRADE_ACCOUNTS_REQUEST), [Open Orders](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-OPEN_ORDERS_REQUEST),  [Trade Positions](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-CURRENT_POSITIONS_REQUEST), and [Historical Order Fills](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-HISTORICAL_ORDER_FILLS_REQUEST).  The Client will then be up-to-date in regards to trading once it receives this information.

In DTC there is a single message, [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE), which is similar to the FIX Execution Report which is used to communicate from the Server to the Client, the details of an order, the status of an order, the most recent action on the order, and Client order actions which results in a rejection.

The reason there is a single unified message is to ensure easier integration on the Client-side, to ensure that the status of an order, and the reason for the sending of the [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE)  is always clear without any confusion. This has proven to be a very good model to follow.  It is the model used by FIX.   The primary difference between the DTC [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message and the FIX Execution Report, is order Cancel and order Cancel/Replace  rejects also use  the same [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message to communicate those rejections. The **OrderUpdateReason** field in the  [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE)  message indicates if the  order update is a rejection  and the specific reason for the rejection.  There is no room for confusion.

The main identifying fields of the [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message are the **ClientOrderID**, **ServerOrderID**, **OrderUpdateReason**, and the **OrderStatus**.

The other fields of the  **ORDER_UPDATE** message need to be  set by a Server when sending the [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message, unless they are identified as optional by the DTC Protocol and are not relevant for the particular order.

The only exception to this is when the **OrderUpdateReason** is a ***REJECT**.  In this case,  the only fields that need to be set in the [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message are **TotalNumMessages, MessageNumber, Symbol, ClientOrderID, OrderStatus, OrderUpdateReason**.

When an order fills, an **ORDER_UPDATE** message needs to be sent from the Server to the Client, and a [POSITION_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-POSITION_UPDATE) needs to be sent to the Client updating the Trade Position data for the Symbol and Trade Account.
...
1. The client will submit the Parent order using the [SUBMIT_NEW_SINGLE_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_SINGLE_ORDER) message. In the parent order message it is necessary for the Client to set the   **s_SubmitNewSingleOrder::IsParentOrder** field to 1. This signifies to the Server that this is a Parent order of a bracket order.  


                The Server will use **IsParentOrder** as a flag to know that this message is a parent order. The Server must hold onto this order until it  receives the subsequent [SUBMIT_NEW_OCO_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_OCO_ORDER) message  and then process all of the orders as one complete set. If the next  message the Server receives is not a [SUBMIT_NEW_OCO_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_OCO_ORDER)  message, then it should reject the [SUBMIT_NEW_SINGLE_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_SINGLE_ORDER)  message with an [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message.
2. The client will submit the 2 child orders  using the [SUBMIT_NEW_OCO_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_OCO_ORDER) message.
3. In the SUBMIT_NEW_OCO_ORDER message, the Client  needs to set the **s_SubmitNewOCOOrder::ParentTriggerClientOrderID** field. This field needs to be set to the **ClientOrderID** used in the previous [SUBMIT_NEW_SINGLE_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_SINGLE_ORDER) message which is the parent order for a bracket order.  This signifies that the two orders in the OCO order are child orders of the specified parent.
...
5. The Server needs to acknowledge the three orders which have been sent by sending a separate [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) for each of the three orders.  The  **OrderUpdateReason** needs to be either **NEW_ORDER_ACCEPTED** or **NEW_ORDER_REJECTED**. If any of the orders are rejected, they all should be rejected by the Server. Further updates to the status of the orders needs to be communicated by the Server to the Client by sending a [ORDER_UPDATE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_TradingRelatedMessages.php#Messages-ORDER_UPDATE) message to the Client individually for each order.
...
7. Each of the three orders can be independently canceled and modified by using the [CANCEL_REPLACE_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-CANCEL_REPLACE_ORDER) or [CANCEL_ORDER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-CANCEL_ORDER)  messages. When the parent order is canceled, the children need to be canceled as well by Server.
...
- [SUBMIT_NEW_SINGLE_ORDER_INT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_SINGLE_ORDER_INT)
- [SUBMIT_NEW_OCO_ORDER_INT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-SUBMIT_NEW_OCO_ORDER_INT)
- [CANCEL_REPLACE_ORDER_INT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php#Messages-CANCEL_REPLACE_ORDER_INT)
...
With the [Order Entry and Modification Messages](https://www.sierrachart.com/index.php?page=doc/DTCMessages_OrderEntryModificationMessages.php), Price and Quantity fields are required to be set so they will never use unset values.
...
3. The Server can optionally set the **OneHistoricalPriceDataRequestPerConnection** field to 1 in the  [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE)  message to indicate that it only will accept one historical price data request per network connection. After the first request is served or rejected, the network connection will be gracefully closed at the appropriate time by the Server. The Server should close the socket when the Client has read all of the data. This method simplifies the serving of historical price data on the Server side and the implementation on the Client side when data compression is used.
4. The Client will send to the Server a [HISTORICAL_PRICE_DATA_REQUEST](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_REQUEST) message with the details of the historical data to be returned by the Server.
5. If the Server rejects the historical data request, it will send a [HISTORICAL_PRICE_DATA_REJECT](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_REJECT) message.  This is never ZLib compressed. At this point, the communication is complete for the particular historical data request.
6. If the Server accepts the historical data request, it will send a [HISTORICAL_PRICE_DATA_RESPONSE_HEADER](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_RESPONSE_HEADER) message.  This is never ZLib compressed.
7. In the case of a request other than for Tick data, the Server will respond with a series of [HISTORICAL_PRICE_DATA_RECORD_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_RECORD_RESPONSE) messages until the historical data request is completely fulfilled. 
...
8. In the case of a request for Tick data, the Server will respond with a series of [HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE) messages until the historical data request is completely fulfilled. If the Server does not support Tick data or does not have Tick data for the specified  time period it can respond with [HISTORICAL_PRICE_DATA_RECORD_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_RECORD_RESPONSE)  messages. 
...
*DTC strictly defines the ordering of records returned, from oldest to newest*. When the Server writes these records into the network socket, it should write them in batches for efficiency. The batch size will be determined by the Server.
9. The final historical data record message ([HISTORICAL_PRICE_DATA_RECORD_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_RECORD_RESPONSE), [HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_TICK_RECORD_RESPONSE)), needs to set the **IsFinalRecord** structure  field to 1 to  flag that it is the final record.
...
13. Since historical price data is not the type of data the Client will be making frequent requests for, the Server can close the socket connection after a certain period of inactivity determined by the Server (example: 30 seconds). If the Server has set the field  **OneHistoricalPriceDataRequestPerConnection** to 1 in the [LOGON_RESPONSE](https://www.sierrachart.com/index.php?page=doc/DTCMessages_AuthenticationConnectionMonitoringMessages.php#Messages-LOGON_RESPONSE) message, it will only respond to one request from the Client and gracefully closed a network socket when done. The Client should not reestablish this connection until it needs historical  price data again.
...
This is an 8-bit unsigned integer value.
...
This is a character string. The final byte is always a null terminator for Binary encoding and Binary encoding with Variable Length Strings.
...
The following enumerations are for the [Historical Price Data Reject](https://www.sierrachart.com/index.php?page=doc/DTCMessages_HistoricalPriceDataMessages.php#Messages-HISTORICAL_PRICE_DATA_REJECT) message.
