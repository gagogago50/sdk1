...
#pragma pack(push, 1)
	...
	struct s_MarketOrdersRequest
	{
		...
		char Symbol[SYMBOL_LENGTH] = {};
		char Exchange[EXCHANGE_LENGTH] = {};
		int32_t SendQuantitiesGreaterOrEqualTo = 0;
...
#pragma pack(pop)
	...
	struct s_CancelReplaceOrder
	{
		...
		int32_t Unused = 0;
		TimeInForceEnum TimeInForce = TIF_UNSET;//Nonstandard. Optional.
		t_DateTime GoodTillDateTime = 0;//Nonstandard. Optional.
		uint8_t UpdatePrice1OffsetToParent = 0;//Nonstandard. Optional.
		char TradeAccount[TRADE_ACCOUNT_LENGTH] = {};

		char Price1AsString[PRICE_STRING_LENGTH] = {};//Nonstandard. Optional.
		char Price2AsString[PRICE_STRING_LENGTH] = {};//Nonstandard. Optional.
	...
	struct s_AccountBalanceUpdate
	{
		...
		t_DateTimeWithMicrosecondsInt LastOrderActivityDateTime = 0;
		...
		t_DateTimeWithMicrosecondsInt GetLastOrderActivityDateTime() const;
